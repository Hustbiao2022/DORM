...
2. Set the parameters in **Global parameters**:
    ...
    - **HR path:** Click the ‘Choose’ button and select the folder containing raw HR data on your computer. (Full forms of abbreviations are listed in the ‘Abbreviation Table’ of the NOTE at the end. This applies throughout.)
